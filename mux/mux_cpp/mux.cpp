...
// load src
Fr_div(&expaux[0],&signalValues[mySignalStart + 1],&signalValues[mySignalStart + 2]); // line circom 6
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_mul(&expaux[2],&signalValues[mySignalStart + 0],&signalValues[mySignalStart + 2]); // line circom 7
Fr_eq(&expaux[0],&signalValues[mySignalStart + 1],&expaux[2]); // line circom 7
